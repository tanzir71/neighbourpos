...
Assert-SourceContains $source '\.saleTile strong,\.saleTile \.name\{font-size:17px' 'Production checkout product names should keep the larger tile sizing'
Assert-SourceContains $demo '\.saleTile strong,\.saleTile \.name\{font-size:17px' 'Static demo checkout product names should keep the larger tile sizing'
