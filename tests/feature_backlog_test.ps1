...
Assert-SourceContains $source 'today_close' 'End-of-day close payload is missing'
Assert-SourceContains $source "Today's close" 'Reports close card copy is missing'
Assert-SourceContains $source 'close_print' 'Reports close print control is missing'
Assert-SourceContains $source 'payment_methods' 'Reports close payment method totals are missing'
...
Assert-SourceContains $source "sqlite::memory:" 'Developer self-test should use an in-memory SQLite fixture'
Assert-SourceContains $source "segment_filter:" 'Developer self-test segment matrix is missing'
Assert-SourceContains $source "export_headers:" 'Developer self-test export header checks are missing'
